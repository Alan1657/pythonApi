...
class Product(models.Model):
    ...
    product_supplier = models.ForeignKey(Supplier, on_delete=models.CASCADE, related_name='product_supplier')
...
class Customer(models.Model):
    customer_person = models.ForeignKey(Person, on_delete=models.CASCADE, related_name='customer_person')

class Employee(models.Model):
    Employee_RUC = models.CharField(max_length=20)
    Employee_cargo = models.CharField(max_length=100)
    Employee_person = models.ForeignKey(Person, on_delete=models.CASCADE, related_name='employee_person')

class Pedido(models.Model):
    product = models.ForeignKey(Product, on_delete=models.SET_NULL, null=True, default=1, related_name='product_pedido')
